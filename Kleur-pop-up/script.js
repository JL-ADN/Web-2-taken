...
var bodyColor = prompt("body color?"); // we zetten woord gekregen van de gebruiker in de variabele color (zie beetje als lege doos)
...
var h1Color = prompt("titel color?");
